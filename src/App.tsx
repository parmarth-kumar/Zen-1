...
// The footer text and link have styling to fit the overall app theme and provide clear information. */}
 ...
 <footer className="relative z-10 border-t border-gray-800/50 py-8 px-4 sm:px-6 lg:px-8 mt-16">
        <div className="max-w-7xl mx-auto text-center text-sm text-gray-500">
          <p>© {new Date().getFullYear()} Space Biology Knowledge Engine | Built for the NASA Space Apps Challenge by <a href="https://www.spaceappschallenge.org/2025/find-a-team/zen-1/?tab=members" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:underline">Zen-1</a>
          </p>
          <p className="mt-2">
